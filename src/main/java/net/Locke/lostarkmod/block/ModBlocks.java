...
public class ModBlocks {
        ...
        public static final RegistryObject<Block> ARMOR_FORGING_TABLE = registerBlock("armor_forging_table",
                        () -> new ArmorForgingTable(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).noOcclusion()));
